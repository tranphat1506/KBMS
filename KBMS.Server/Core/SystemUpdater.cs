...
public static class SystemUpdater
{
    ...
    private record MigrationContext(KBMS.Knowledge.Core.StorageRouter Router, UserCatalog UserCatalog);
    ...
    public static void Run(KbCatalog kbCatalog, ConceptCatalog conceptCatalog, UserCatalog userCatalog, KBMS.Knowledge.Core.StorageRouter router)
    {
    ...
    private static void InitializeSystemSchema(KBMS.Knowledge.Core.StorageRouter router)
    {
        // 1. Settings Concept
    ...
    private static void UpdateVersion(KBMS.Knowledge.Core.StorageRouter router, string version)
    {
