...
public class ManagementManager
{
    ...
    private readonly KBMS.Knowledge.Core.StorageRouter _v3Router;
    ...
    public ManagementManager(ConnectionManager connectionManager, SystemLogger sysLogger, KBMS.Knowledge.Core.StorageRouter v3Router, KBMS.Storage.Core.UserCatalog userCatalog)
    {
