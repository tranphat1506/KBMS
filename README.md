...
### 2. Kiến trúc & Mô hình (Architecture & Models)
* [Tổng quan Kiến trúc](docs/02-architecture/01-overview.md) - Sơ đồ Use Case và Layered Architecture.
* [Mô hình Tri thức COKB](docs/03-models/01-cokb-intro.md) - Đặc tả Concepts, Objects và Rules.
...
* [Tài liệu Ngôn ngữ](docs/04-kbql-reference/) - Chi tiết cú pháp DDL, DML, DQL và quy tắc suy diễn.

### 4. Kỹ thuật Chuyên sâu (Internals)
* [Storage Engine](docs/05-storage/01-overview.md) - B+ Tree, Paging, Buffer Pool & WAL.
* [Reasoning Engine](docs/06-reasoning/01-reasoning-engine.md) - Forward Chaining & Equation Solving.
* [Network Layer](docs/07-network/01-protocol.md) - Đặc tả Giao thức nhị phân và Packet Handling.
* [Server Orchestration](docs/08-server/01-orchestration.md) - Dispatcher & Request Lifecycle.

### 5. Thực hành & Mở rộng
* [Gói Tri thức Mẫu](docs/11-use-cases/03-samples.md) - Các template về Tài chính, Động vật, Quản lý kho.
* [Ví dụ Hình học](docs/11-use-cases/01-geometry.md) & [Ví dụ Y tế](docs/11-use-cases/02-medical-diagnosis.md).
* [Developer Guide](docs/13-developer/01-extensibility.md) - Cách mở rộng Function và Operator mới.
