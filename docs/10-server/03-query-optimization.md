...
Trong [KBMS](../00-glossary/01-glossary.md#kbms) V3, [Query Optimizer](../00-glossary/01-glossary.md#query-optimizer) nhận đầu vào là cây cú pháp [AST](../00-glossary/01-glossary.md#ast) từ bộ [Parser](../00-glossary/01-glossary.md#parser) và thực hiện các bước tối ưu hóa sau:
...
- **Sequential [Page](../00-glossary/01-glossary.md#page) Read (Cost 1.0)**: Thao tác đọc một trang 16KB từ đĩa cứng được lấy làm đơn vị đo lường cơ bản cho toàn bộ hệ thống.
...
| :--- | :--- |
| **SequentialScan** | Quét đĩa tuần tự, đọc các Slotted Pages liên quan đến [Concept](../00-glossary/01-glossary.md#concept). |
| **HashJoin** | Kết hợp hai luồng thực thể dựa trên khóa băm, tối ưu cho tập dữ liệu lớn ($>10,000$ bản ghi). |
| **Filter** | Áp dụng chiến lược **[Predicate Pushdown](../00-glossary/01-glossary.md#predicate-pushdown)** để lọc dữ liệu ngay tại tầng thấp nhất. |

---

## 4. Hiệu năng Định lượng

Kiến trúc tối ưu hóa này cho phép [KBMS](../00-glossary/01-glossary.md#kbms) V3 đạt được các chỉ số ấn tượng trong môi trường Stress Test thực tế:
...
Mô hình tối ưu hóa này đảm bảo máy chủ [KBMS](../00-glossary/01-glossary.md#kbms) luôn vận hành với hiệu suất cao nhất ngay cả khi cơ sở tri thức mở rộng tới hàng triệu thực thể.
