...
Hệ thống cho phép các Client (đặc biệt là [KBMS](../00-glossary/01-glossary.md#kbms) Studio) truy xuất dữ liệu vận hành thời gian thực thông qua bộ lệnh quản trị cấp cao:
...
Đây là tính năng độc đáo nhất của [KBMS](../00-glossary/01-glossary.md#kbms) V3, cho phép "lắng nghe" mọi biến động của máy chủ ngay lập tức.
