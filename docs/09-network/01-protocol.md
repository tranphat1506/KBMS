...
*Bảng 9.1: Đặc tả cấu trúc [Header](../00-glossary/01-glossary.md#header) nhị phân của gói tin trong giao thức [KBMS](../00-glossary/01-glossary.md#kbms)*
| Offset | Trường dữ liệu | Kiểu | Mô tả |
| :--- | :--- | :--- | :--- |
| **0 - 3** | **Total Length**| Int32 | Tổng kích thước gói tin ([Big-Endian](../00-glossary/01-glossary.md#big-endian)). |
| **4** | **[Message Type](../00-glossary/01-glossary.md#message-type)**| Byte | Loại thông điệp (LOGIN, QUERY, RESULT, ...). |
...
| **M+1 - End** | **Payload** | String | Nội dung chính của thông điệp ([JSON](../00-glossary/01-glossary.md#json)/Text). |

---

## 2. Danh mục Loại thông điệp

*Bảng 9.2: Danh mục các loại thông điệp trong giao thức nhị phân [KBMS](../00-glossary/01-glossary.md#kbms)*
| Giá trị | Tên loại | Mục đích sử dụng |
| :--- | :--- | :--- |
| **1** | **LOGIN** | Gửi thông tin đăng nhập (User/Pass). |
| **2** | **QUERY** | Gửi mã nguồn [KBQL](../00-glossary/01-glossary.md#kbql) để thực hiện suy diễn/truy vấn. |
| **3** | **RESULT** | Trả về thông tin kết quả đơn lẻ hoặc thông báo thành công. |
| **4** | **ERROR** | Trả về thông tin lỗi (Runtime, [Parser](../00-glossary/01-glossary.md#parser), Auth). |
...
- **[Session Isolation](../00-glossary/01-glossary.md#session-isolation)**: Server sử dụng Session ID trong [Header](../00-glossary/01-glossary.md#header) để định danh quyền hạn và không gian tên (Current KB) cho mỗi gói tin nhận được.
