...
![code_test_dashboard.png](../assets/diagrams/code_test_dashboard.png)
*Hình 13.1: Minh chứng mã nguồn API giám sát (Dashboard API).*

### Minh chứng Giao diện (Studio IDE):
![studio_concept_editor.png](../assets/diagrams/studio_concept_editor.png)
...
![terminal_test_studio_electron.png](../assets/diagrams/terminal_test_studio_electron.png)
