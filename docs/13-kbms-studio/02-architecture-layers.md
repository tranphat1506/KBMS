...
*Hình 13.2: Cơ chế [Server Push](../00-glossary/01-glossary.md#server-push) cho các thông báo hệ thống thời gian thực.*
...
3.  **Dispatch**: [Electron](../00-glossary/01-glossary.md#electron) Main nhận gói tin và gửi vào Redux Store của [React](../00-glossary/01-glossary.md#react).
