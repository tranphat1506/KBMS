...
| :--- | :--- | :--- | :--- |
| **0** | `999999...5555` | [GUID](../00-glossary/01-glossary.md#guid) | 16B |
...
1.  **[Header](../00-glossary/01-glossary.md#header) (24B):** Cập nhật `TupleCount = 1`, `FreeSpacePointer = 16341` ($16384 - 43$).
...
[Tuple](../00-glossary/01-glossary.md#tuple) được tạo ra bởi `ModelBinaryUtility.SerializeConcept()` gồm **13 Fields** (2 [GUID](../00-glossary/01-glossary.md#guid) + 1 Name + 10 danh sách con). Dưới đây là bố cục của 5 Fields quan trọng nhất:

*Bảng 7.11: Phân tích các trường trong [Tuple](../00-glossary/01-glossary.md#tuple) Siêu dữ liệu [Concept](../00-glossary/01-glossary.md#concept).*

| Field | Nội dung | Mô tả | Kích thước |
| :--- | :--- | :--- | :--- |
| **0-1** | `AAAA...`, `BBBB...` | [Concept](../00-glossary/01-glossary.md#concept)/KB ID | 16B / ea |
...
Dưới đây là mô phỏng 48 bytes mở đầu của [Tuple](../00-glossary/01-glossary.md#tuple) [Concept](../00-glossary/01-glossary.md#concept) sau khi được tuần tự hóa (đã giải mã AES, chưa bao gồm sub-blobs rỗng):
