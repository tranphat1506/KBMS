...
[KBMS](../00-glossary/01-glossary.md#kbms) sử dụng cây [B+ Tree](../00-glossary/01-glossary.md#b-tree) làm cấu trúc dữ liệu chính để quản lý và truy xuất các thực thể (`ObjectInstance`) trong mỗi [Concept](../00-glossary/01-glossary.md#concept). [B+ Tree](../00-glossary/01-glossary.md#b-tree) là lựa chọn tối ưu cho việc truy vấn dữ liệu từ bộ nhớ ngoài (Disk) vì nó giảm thiểu số lần đọc đĩa (I/O) cần thiết.

---

## 1. Cấu trúc Đa tầng

Cây [B+ Tree](../00-glossary/01-glossary.md#b-tree) trong [KBMS](../00-glossary/01-glossary.md#kbms) V3 thường duy trì từ 3 đến 5 tầng tùy thuộc vào khối lượng tri thức:

![Sơ đồ Cấu trúc Đa tầng Cây B+ Tree](../assets/diagrams/btree_graph.png)
*Hình 7.3: Sơ đồ cấu trúc đa tầng của cây [B+ Tree](../00-glossary/01-glossary.md#b-tree) trong việc quản lý thực thể.*

1.  **Nút Gốc (Root Node):** Điểm bắt đầu của mọi truy vấn. Nếu cây chỉ có 1 trang, Root đồng thời là Leaf.
...
Khác với các hệ quản trị CSDL truyền thống thường tách rời Index và Data, [KBMS](../00-glossary/01-glossary.md#kbms) V3 sử dụng mô hình **[Clustered Index](../00-glossary/01-glossary.md#clustered-index)**:
