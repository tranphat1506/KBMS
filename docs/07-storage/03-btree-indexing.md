# 07.3. Chỉ mục Cây B+ Tree (Indexing Structure)
...
### Chèn và Tách trang (Insert & Split)
...
## 3. Clustered Index trong KBMS

Khác với các hệ quản trị CSDL truyền thống thường tách rời Index và Data, KBMS V3 sử dụng mô hình **Clustered Index**:
