...
*Hình 7.3: Sơ đồ cấu trúc đa tầng của cây B+ Tree trong việc quản lý Fact.*
...
*Hình 7.4: Cơ chế tách nút (Split) khi trang dữ liệu (Page) bị đầy (Overflow).*
