...
[KBMS](../00-glossary/01-glossary.md#kbms) cho phép định cấu hình người dùng và vai trò để bảo vệ tri thức khỏi các truy cập không mong muốn.
...
*   **ADMIN**: Có toàn quyền trên tất cả các KB, [Concept](../00-glossary/01-glossary.md#concept) và người dùng khác.
