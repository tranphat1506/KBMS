...
3.  **Persist (Tùy chọn):** Nếu có từ khóa `SAVE`, các kết quả vừa tìm thấy sẽ được lưu trực tiếp thành một [Fact](../00-glossary/01-glossary.md#fact) mới vào [Concept](../00-glossary/01-glossary.md#concept) tương ứng.
...
*   **SHOW RELATIONS**: Liệt kê các quan hệ giữa các [Concept](../00-glossary/01-glossary.md#concept).
...
*   **DESCRIBE {[CONCEPT](../00-glossary/01-glossary.md#concept)|KB|[RULE](../00-glossary/01-glossary.md#rule)|...} <name>**: Hiển thị chi tiết cấu trúc định nghĩa của một đối tượng.
...
*Ví dụ:* `SELECT * FROM <concept_name>.variables;` trả về danh sách các biến và kiểu dữ liệu của [Concept](../00-glossary/01-glossary.md#concept) đó.
