# 06.8. Biểu thức và Hàm số

Biểu thức là thành phần cốt lõi xuất hiện trong các mệnh đề `WHERE`, `IF`, `SET` và hàm `CALC()`. [KBQL](../00-glossary/01-glossary.md#kbql) tích hợp một bộ máy đánh giá biểu thức mạnh mẽ hỗ trợ đầy đủ các phép toán và hàm học thuật.
...
[KBMS](../00-glossary/01-glossary.md#kbms) tích hợp sẵn các hàm toán học sau đây để phục vụ tính toán tri thức:

*Bảng 6.4: Danh mục Hàm tích hợp (Built-in Functions) trong [KBQL](../00-glossary/01-glossary.md#kbql)*
...
## 4. Tương tác với Biến

Bên trong các biểu thức, bạn có thể tham chiếu trực tiếp đến tên các biến của [Concept](../00-glossary/01-glossary.md#concept) hiện tại. Nếu có `JOIN`, hãy sử dụng Alias để phân biệt: `e.salary * 1.1`.
