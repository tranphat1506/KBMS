# 01. Kiến trúc Mô hình COKB

Mô hình **COKB (Computational Objects Knowledge Base)** là nền tảng lý thuyết cốt lõi của KBMS, cho phép biểu diễn tri thức dưới dạng các đối tượng có khả năng tính toán và suy diễn.
