...
*   **Tự động kết nối lại (Auto-reconnect)**: [CLI](../00-glossary/01-glossary.md#cli) tự động thử kết nối lại nếu máy chủ bị ngắt kết nối đột ngột ([Heartbeat](../00-glossary/01-glossary.md#heartbeat) timeout).

---

## 2. Các Lệnh Hệ thống Đặc biệt

*Bảng 12.1: Danh mục lệnh điều khiển [CLI](../00-glossary/01-glossary.md#cli)*
| Lệnh | Mô tả |
| :--- | :--- |
...
Để mang lại trải nghiệm chuyên nghiệp như một hệ quản trị CSDL thực thụ, [CLI](../00-glossary/01-glossary.md#cli) được tích hợp các phím tắt:
