# 5.3. Đánh giá Hiệu năng Hệ quản trị tri thức (macOS)

Chương này tập trung vào các chỉ số hiệu năng (Metrics) được đo đạc trực tiếp trên kiến trú phần cứng **Apple M1 (8 cores)**. Việc tối ưu hóa ở tầng nhị phân và mạng nốt Rete giúp KBMS đạt được những chỉ số vượt trội so với các hệ thống dựa trên tệp văn bản truyền thống.
...
*Bảng 5.3: Đặc tả hiệu năng phản hồi các thành phần hệ thống*
...
*Bảng 5.3: Chỉ số Throughput và Scalability trên các bộ dữ liệu*
...
*Bảng 5.4: Mức độ tiêu thụ tài nguyên thực tế*
