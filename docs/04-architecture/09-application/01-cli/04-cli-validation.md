...
*Bảng 4.12: Kịch bản kiểm lý định dạng kết xuất dữ liệu trong giao diện CLI*
...
Việc kiểm định thành công giao diện CLI khẳng định tính sẵn sàng của công cụ quản trị trong việc điều phối và giám sát hệ thống tri thức **[KBMS](../../../00-glossary/01-glossary.md#kbms)** một cách chuyên sâu thông qua ngôn ngữ dòng lệnh.
