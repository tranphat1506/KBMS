...
*Hình: Cấu trúc 6 thành phần hình thức của KnowledgeBase (C, H, R, Ops, Funcs, Rules).*
...
*Hình: Sơ đồ lớp đặc tả cấu trúc nội tại phức hợp của một [Concept](../../00-glossary/01-glossary.md#concept).*
...
*Hình: Sơ đồ minh họa quan hệ Parent-Child thông qua HierarchyType.*
...
*Hình: Sơ đồ lớp đặc tả Relation với Domain, Range và tri thức nội tại.*
...
*Hình: Sơ đồ lớp đặc tả cấu trúc [Rule](../../00-glossary/01-glossary.md#rule) và cấu trúc đệ quy Expression.*
...
*Hình: Sơ đồ lớp đặc tả thành phần Function và Operator.*
...
Thực thể (**[ObjectInstance](../../00-glossary/01-glossary.md#objectinstance)**) là các thể hiện cụ thể mang giá trị thực tế của một Concept:

![Sơ đồ cấu trúc Thực thể Đối tượng. | width=0.6](../../assets/diagrams/kbms_instance_v5.png)
*Hình: Sơ đồ lớp đặc tả ObjectInstance và cơ chế lưu trữ giá trị Dictionary.*
