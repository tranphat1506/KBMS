...
Ngôn ngữ **[KBQL](../../00-glossary/01-glossary.md#kbql) (Knowledge Base Query Language)** là phương thức giao tiếp chính để tương tác với hệ quản trị cơ sở tri thức [KBMS](../../00-glossary/01-glossary.md#kbms). KBQL được thiết kế dựa trên sự kế thừa các cú pháp tiêu chuẩn của SQL trong thao tác dữ liệu, đồng thời mở rộng các khả năng suy diễn tri thức dựa trên hệ thống logic vị từ và tập luật.
...
2.  **Định hướng Tri thức:** Tích hợp sâu các thực thể hình thức như [Concept](../../00-glossary/01-glossary.md#concept), [Fact](../../00-glossary/01-glossary.md#fact) và [Rule](../../00-glossary/01-glossary.md#rule), vượt xa giới hạn của mô hình Bảng - Bản ghi truyền thống.
3.  **Tự động Suy diễn:** Kết quả truy vấn có khả năng tự cập nhật và suy luận thông qua bộ máy suy diễn ([Inference Engine](../../00-glossary/01-glossary.md#inference-engine)) tích hợp, giảm thiểu việc triển khai logic thủ công tại lớp ứng dụng.
