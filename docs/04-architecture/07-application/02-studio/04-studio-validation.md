...
*Hình: Minh chứng mã nguồn [API](../../../00-glossary/01-glossary.md#api) giám sát (Dashboard API).*
...
*Hình: Giao diện soạn thảo tri thức trực quan trong [KBMS](../../../00-glossary/01-glossary.md#kbms) Studio.*
...
*Hình: Chứng minh luồng dữ liệu Studio và [Electron](../../../00-glossary/01-glossary.md#electron) Main truyền nhận gói tin nhị phân.*
