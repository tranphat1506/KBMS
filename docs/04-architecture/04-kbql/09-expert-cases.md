...
Hệ thống KBMS không chỉ tính toán một chiều mà còn có khả năng giải ngược các tham số đầu vào khi biết kết quả đầu ra thông qua các thuật toán **[Newton-Raphson](../../00-glossary/01-glossary.md#newton-raphson)** và **Brent**.
...
Dùng [Trigger](../../00-glossary/01-glossary.md#trigger) để kích hoạt một luồng suy diễn ở một Concept hoàn toàn khác.
