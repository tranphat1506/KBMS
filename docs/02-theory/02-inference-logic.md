...
## 1. Các Quy tắc Suy luận (Inference Rules)
...
*   **RC5 (Giải hệ phương trình)**: Kết hợp nhiều biến và phương trình để giải đồng thời bằng phương pháp Newton-Raphson hoặc Brent [2].
*   **RC6 (Hành vi nội bộ)**: Suy diễn dựa trên các đặc tính cấu thành (PART-OF) [2].

## 2. Thuật toán Tìm bao đóng (F-Closure Algorithm)

Đây là thuật toán trọng tâm của KBMS dùng để tìm tập đóng tri thức lớn nhất có thể suy ra được từ tập giả thiết **GT**.
...
## 3. Chiến lược Giải bài toán: Heuristics
