...
Một cơ sở tri thức [COKB](../00-glossary/01-glossary.md#cokb) được xác định bởi bộ 6 thành phần [1, 3]:
...
Trong mô hình [COKB](../00-glossary/01-glossary.md#cokb), các khái niệm được phân tầng dựa theo độ phức tạp của cấu trúc attributes:
