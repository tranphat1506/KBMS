# 02.1. Mô hình Đối tượng Tính toán COKB
...
## 1. Thành phần Hệ thống tri thức COKB
...
## 2. Mô hình Đối tượng Tính toán (Computational Object)
...
2.  **Facts (Facts)**: Các giá trị hoặc tính chất vốn có của đối tượng đã được xác định.
