...
![query_lifecycle_v3.png](../assets/diagrams/query_lifecycle_v3.png)
...
![packet_processing_v3.png](../assets/diagrams/packet_processing_v3.png)
*Hình: Sơ đồ Luồng Xử lý Gói tin (Packet Processing Flow)*
