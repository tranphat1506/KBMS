...
*   **Kỹ thuật:** Sử dụng trình phân tích cú pháp **[Recursive Descent](../00-glossary/01-glossary.md#recursive-descent)** (Phân tích đi xuống đệ quy) để khớp các Tokens với bộ ngữ pháp của KBQL.
