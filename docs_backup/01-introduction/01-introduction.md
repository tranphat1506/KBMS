...
*   **Chương 2 – Cơ sở lý thuyết COKB**: Trình bày tổng quan về mô hình Đối tượng Tính toán (COKB), bao gồm cấu trúc, phân cấp khái niệm và nền tảng logic suy diễn.
...
*   **Chương 5 – Định nghĩa Mô hình và Khái niệm**: Đặc tả các mô hình dữ liệu cốt lõi sử dụng trong hệ thống KBMS.
*   **Chương 6 – Ngôn ngữ truy vấn KBQL**: Trình bày cú pháp, ngữ nghĩa và các nhóm lệnh của ngôn ngữ truy vấn tri thức KBQL.
*   **Chương 7 – Tầng lưu trữ vật lý**: Mô tả cơ chế lưu trữ nhị phân, cấu trúc trang, chỉ mục B+ Tree và giao thức nhật ký WAL.
*   **Chương 8 – Bộ máy suy diễn**: Trình bày chi tiết thuật toán F-Closure, giải phương trình và cơ chế suy diễn theo ngữ cảnh.
...
*   **Chương 10 – Tầng máy chủ**: Trình bày cơ chế điều phối phiên làm việc, quản lý nhật ký và hạ tầng vận hành của máy chủ KBMS.
*   **Chương 11 – Bộ phân tích cú pháp**: Mô tả kiến trúc [Lexer](../00-glossary/01-glossary.md#lexer), [Parser](../00-glossary/01-glossary.md#parser) và cây cú pháp trừu tượng ([AST](../00-glossary/01-glossary.md#ast)) của ngôn ngữ KBQL.
*   **Chương 12 – Giao diện dòng lệnh ([CLI](../00-glossary/01-glossary.md#cli))**: Giới thiệu công cụ CLI, luồng xử lý lệnh và các kịch bản sử dụng thực tiễn.
*   **Chương 13 – KBMS Studio**: Trình bày ứng dụng Studio dạng IDE tích hợp để thiết kế, quản trị và kiểm chứng tri thức trực quan.
