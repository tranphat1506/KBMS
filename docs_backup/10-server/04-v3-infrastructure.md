...
*   **`ConceptCatalog.cs`**: Quản lý hàng ngàn [Concept](../00-glossary/01-glossary.md#concept) và [Rule](../00-glossary/01-glossary.md#rule) của mỗi KB. Nó hỗ trợ nạp đè và thay đổi cấu trúc Concept mà không làm hỏng dữ liệu vật lý.
...
Đây là "Cây cầu nối" cho phép người dùng cũ của KBMS V2 chuyển toàn bộ tri thức sang V3. Nó thực hiện quét đĩa cũ, bóc tách `Objects` và tự động băm nhỏ dữ liệu để đẩy vào cấu trúc **[Slotted Page](../00-glossary/01-glossary.md#slotted-page) 16KB** của V3.
