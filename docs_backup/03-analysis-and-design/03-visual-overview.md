...
2.  **Computing Stage**: 
    ...
    - **Optimization**: [Query Optimizer](../00-glossary/01-glossary.md#query-optimizer) phân tích AST và lược đồ hệ thống để thiết lập **[Execution Plan](../00-glossary/01-glossary.md#execution-plan)** tối ưu dựa trên mô hình chi phí (CBO).
