...
### Rule
**Rule** định nghĩa mối quan hệ logic giữa các Fact. Khi dữ liệu (Fact) thay đổi, các Rule liên quan có thể được kích hoạt để tạo ra Fact mới hoặc cập nhật Fact hiện có ([Forward Chaining](../00-glossary/01-glossary.md#forward-chaining)).
