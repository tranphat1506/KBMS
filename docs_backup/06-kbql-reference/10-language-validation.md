...
*Hình 6.1: Kết quả kiểm thử bộ phân tích cú pháp (Parser) với hàng trăm kịch bản kiểm thử trên 21,000 dòng mã kịch bản.*
...
*Hình 6.2: Luồng [Token](../00-glossary/01-glossary.md#token) được phân tách bởi Lexer trước khi đưa vào Parser.*
