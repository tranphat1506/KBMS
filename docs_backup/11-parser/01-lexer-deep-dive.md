...
*   **Đa dòng**: Chuỗi có thể kéo dài qua nhiều dòng, Lexer sẽ tự nạp các ký tự xuống dòng vào giá trị [literal](../00-glossary/01-glossary.md#literal).
...
Lexer thực hiện tra cứu không phân biệt hoa thường (`OrdinalIgnoreCase`) để tạo ra các Token có Type tương ứng, giúp [Parser](../00-glossary/01-glossary.md#parser) xử lý nhanh chóng mà không cần so khớp chuỗi (String comparison).
