...
### 2.1. `VariableNode`
Đại diện cho các thuộc tính của [Concept](../00-glossary/01-glossary.md#concept) (Ví dụ: `a`, `age`). Parser hỗ trợ truy cập thuộc tính lồng nhau thông qua dấu chấm (`p1.x`), giúp xử lý tri thức đa tầng.
